...
```{r dplyr pic, echo=FALSE, eval=TRUE, out.width="25%", fig.align='center'}
...
```{r ggplot2 pic, echo=FALSE, eval=TRUE, out.width="25%", fig.align='center'}
...
```{r readr pic, echo=FALSE, eval=TRUE, out.width="25%", fig.align='center'}
...
```{r tidyr pic, echo=FALSE, eval=TRUE, out.width="25%", fig.align='center'}
